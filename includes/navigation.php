...
<nav class="bg-blue-600 text-white shadow-lg border-b border-blue-700">
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-3">
            ...
            <div class="flex items-center space-x-3">
                ...
                <!-- Mobile menu button -->
                <button class="md:hidden focus:outline-none p-2 rounded-md text-white hover:bg-blue-700" onclick="toggleMobileMenu()">
    ...
    function toggleMobileMenu() {
        ...
        if (!mobileMenu.classList.contains('hidden')) {
            document.addEventListener('click', function closeMenu(e) {
                if (!e.target.closest('.mobile-menu-content') && !e.target.closest('[onclick="toggleMobileMenu()"]')) {
